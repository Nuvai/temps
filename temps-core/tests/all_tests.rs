...
fn test_fractional_times_english() {
    let test_cases = vec![
        (
            "half past 3",
            TimeExpression::Time(Time { hour: 3, minute: 30, second: 0, meridiem: None }),
        ),
        (
            "half past noon",
            TimeExpression::Time(Time { hour: 12, minute: 30, second: 0, meridiem: None }),
        ),
        (
            "quarter past 6",
            TimeExpression::Time(Time { hour: 6, minute: 15, second: 0, meridiem: None }),
        ),
        (
            "quarter to 3",
            TimeExpression::Time(Time { hour: 2, minute: 45, second: 0, meridiem: None }),
        ),
        (
            "quarter to midnight",
            TimeExpression::Time(Time { hour: 23, minute: 45, second: 0, meridiem: None }),
        ),
        (
            "quarter to noon",
            TimeExpression::Time(Time { hour: 11, minute: 45, second: 0, meridiem: None }),
        ),
    ];
...
fn test_number_words_english() {
    let test_cases = vec![
        (
            "in a couple hours",
            TimeExpression::Relative(RelativeTime { amount: 2, unit: TimeUnit::Hour, direction: Direction::Future }),
        ),
        (
            "in a few minutes",
            TimeExpression::Relative(RelativeTime { amount: 3, unit: TimeUnit::Minute, direction: Direction::Future }),
        ),
        (
            "a couple hours ago",
            TimeExpression::Relative(RelativeTime { amount: 2, unit: TimeUnit::Hour, direction: Direction::Past }),
        ),
        (
            "a dozen minutes ago",
            TimeExpression::Relative(RelativeTime { amount: 12, unit: TimeUnit::Minute, direction: Direction::Past }),
        ),
    ];
    ...
    let test_cases = vec![
        (
            ...
            TimeExpression::DayTime(DayTime {
                ...
                time: Time { hour: 8, minute: 0, second: 0, meridiem: None },
            }),
        ),
        (
            "tomorrow afternoon",
            TimeExpression::DayTime(DayTime {
                day: DayReference::Tomorrow,
                time: Time { hour: 13, minute: 0, second: 0, meridiem: None },
            }),
        ),
        (
            "tomorrow evening",
            TimeExpression::DayTime(DayTime {
                day: DayReference::Tomorrow,
                time: Time { hour: 18, minute: 0, second: 0, meridiem: None },
            }),
        ),
        (
            "today evening",
...
fn test_this_expressions_english() {
    let test_cases = vec![
        ...
        (
            ...
            TimeExpression::DayTime(DayTime {
                day: DayReference::Today,
                time: Time { hour: 20, minute: 0, second: 0, meridiem: None },
            }),
        ),
        (
            "this Monday",
...
fn test_standalone_expressions_english() {
    let test_cases = vec![
        ...
        (
            ...
            TimeExpression::DayTime(DayTime {
                day: DayReference::Today,
                time: Time { hour: 17, minute: 0, second: 0, meridiem: None },
            }),
        ),
        (
            "end of day",
        ...
        (
            "teatime",
            TimeExpression::Time(Time { hour: 16, minute: 0, second: 0, meridiem: None }),
        ),
        (
            "later",
            TimeExpression::Relative(RelativeTime { amount: 2, unit: TimeUnit::Hour, direction: Direction::Future }),
...
fn test_the_day_expressions_english() {
    let test_cases = vec![
        ...
        (
            ...
            TimeExpression::Relative(RelativeTime { amount: 2, unit: TimeUnit::Day, direction: Direction::Past }),
        ),
    ];
...
fn test_week_fortnight_english() {
    let test_cases = vec![
        (
            "fortnight",
            TimeExpression::Relative(RelativeTime { amount: 2, unit: TimeUnit::Week, direction: Direction::Future }),
        ),
        (
            "a week from now",
            TimeExpression::Relative(RelativeTime { amount: 1, unit: TimeUnit::Week, direction: Direction::Future }),
        ),
        (
            "a week from today",
            TimeExpression::Relative(RelativeTime { amount: 1, unit: TimeUnit::Week, direction: Direction::Future }),
